                            ...
                            <div className="flex-1 space-y-10">
                                <div className="space-y-6 animate-fade-in-up">
                                    <div className="space-y-2">
                                        <span className="text-2xl md:text-3xl font-black tracking-tighter text-primary">delvare.in</span>
                                        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/40">Founder & CEO</p>
                                    </div>
                                ...
                                <div className="flex flex-wrap justify-center md:justify-start gap-5 animate-fade-in-up [animation-delay:400ms]">
                    ...
                    <div className="container max-w-6xl mx-auto px-4">
                        <div className="grid md:grid-cols-2 gap-16 items-center">
                            <div className="space-y-8 animate-fade-in-up">
                                ...
                                <p className="text-lg text-white/50 leading-relaxed font-medium">
                                    Beyond client services, I am actively building proprietary platforms. ECBills.in is our flagship PaaS—designed for infinite retail scale, precision inventory tracking, and high-availability operations. Like ECBills, my other foundings: Blendly.sbs. Share books to nearby beings, blend through books with others using Blendly, showcasing hosting and independent datasets. etc..
                                </p>

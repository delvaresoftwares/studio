        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative hidden lg:flex items-center justify-center min-h-[600px] w-full">
            <div className="relative w-full h-full flex items-center justify-center transition-transform duration-700 ease-out">
              <div ref={arrowRef} className="absolute z-20 w-64 h-64 bg-white rounded-[3rem] flex flex-col items-center justify-center transition-transform duration-200 ease-out">
              ...
              <div className="absolute top-20 left-10 w-48 h-56 bg-white rounded-3xl p-6 flex flex-col justify-between transition-all cursor-default group/card shadow-lg">
              ...
              <div className="absolute top-10 right-10 w-44 h-44 bg-white rounded-3xl p-6 flex flex-col justify-between transition-all cursor-default group/card shadow-lg">
                <div className="w-12 h-12 rounded-2xl bg-secondary flex items-center justify-center text-primary group-hover/card:bg-primary group-hover/card:text-primary-foreground transition-colors duration-300">
              ...
              <div className="absolute bottom-32 right-0 w-48 h-60 bg-white rounded-3xl p-6 flex flex-col justify-between transition-all cursor-default group/card shadow-lg">
                <div className="w-12 h-12 rounded-2xl bg-secondary flex items-center justify-center text-primary group-hover/card:bg-primary group-hover/card:text-primary-foreground transition-colors duration-300">
              ...
              <div className="absolute bottom-20 left-0 w-52 h-44 bg-white rounded-3xl p-6 flex flex-col justify-between transition-all cursor-default group/card shadow-lg">
                <div className="w-12 h-12 rounded-2xl bg-secondary flex items-center justify-center text-primary group-hover/card:bg-primary group-hover/card:text-primary-foreground transition-colors duration-300">

    ...
    <section id="hero" className="w-full flex items-center justify-center relative min-h-screen p-4">
      <div className="container mx-auto grid md:grid-cols-2 gap-8 items-center pt-20 pb-10">
        <div className="animate-fade-in-up text-center md:text-left">
          <h1 className="font-headline text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter mb-4 bg-gradient-to-br from-foreground to-muted-foreground/70 bg-clip-text text-transparent drop-shadow-sm">
